      ...
      childRoutes: [
        {
          ...
          getComponent(nextState, cb) {
            ...
            importModules.then(([reducer, sagas, component]) => {
              ...
              injectSagas('loginContainer', sagas.default); // add string 'loginContainer'
              renderRoute(component);
            });
        ...
        },
        {
          ...
          childRoutes: [
            {
              path: '/topics/:topicName/add', // adjust from generated '/add' to '/topics/:topicName/add'
              ...
              getComponent(nextState, cb) {
                ...
                importModules.then(([reducer, sagas, component]) => {
                  ...
                  injectSagas('linkFormContainer', sagas.default); // add string 'linkFormContainer'
                  renderRoute(component);
                });
